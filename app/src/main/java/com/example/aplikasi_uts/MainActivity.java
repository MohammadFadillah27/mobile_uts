    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_tujuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent_tujuan = new Intent(MainActivity.this, tujuan.class);
        ...
        btn_konsep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent_konsep = new Intent(MainActivity.this, peta_konsep.class);
        ...
        btn_kunci.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent_kunci = new Intent(MainActivity.this, kunci.class);
